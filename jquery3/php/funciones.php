...
// {
// 	$usuario = GetSQLValueString($_POST["txtidAlmacen"],"text");
...
// 	mysql_select_db("cursopw");
// 	$baja = sprintf("delete from almacenes  where IdAlmacen=%d limit 1", $IdAlmacen);//eliminar el usuario
...
function consultas()
{
	...
	mysql_connect("localhost","root","");
	mysql_select_db("cursopw");
	$consulta = "select * from almacenes order by Nombre";
